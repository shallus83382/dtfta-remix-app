...
export const meta: MetaFunction = () => {
  return [
    { title: "Privacy policy - DTF TRANSFER AUTHORITY" },
    {
      name: "description",
      content: "Privacy Policy for DTF TRANSFER AUTHORITY.",
    },
  ];
};
      ...
      <main className={styles.main}>
        <article className={styles.card}>
          ...
          <p className={styles.text}>
            DTF TRANSFER AUTHORITY operates this store and website, including all
            related information, content, features, tools, products and services,
            in order to provide you, the customer, with a curated shopping
            experience (the &quot;Services&quot;). DTF TRANSFER AUTHORITY is powered
            by Shopify, which enables us to provide the Services to you. This
          ...
          <p className={styles.text}>
            ...
            that is collected anonymously or that has been de-identified, so that
            it cannot identify or be reasonably linked to you. We may collect or
          ...
          <ul className={styles.list}>
            ...
            <li>
              ...
              payment confirmation and other payment details. We do not store your
              full payment card number or CVV. We retain only limited card metadata—including the last four
              digits of your payment card, card brand, and expiration date—for
              display and billing reconciliation purposes.
            </li>
            <li>
          ...
          <h2 className={styles.sectionTitle}>Personal Information Sources</h2>
          <p className={styles.text}>
          ...
          <ul className={styles.list}>
            <li>
              ...
              account, visit or use the Services, communicate with us, or otherwise
          ...
          <p className={styles.text}>
            Depending on how you interact with us or which of the Services you use,
            we may use personal information for the following purposes:
          </p>
          <ul className={styles.list}>
            <li>
              <strong>Provide, Tailor, and Improve the Services.</strong> We use
              your personal information to provide you with the Services, including
              to perform our contract with you, to process your payments, to fulfill
              your orders, to remember your preferences and items you are interested
              ...
              to facilitate any returns and exchanges, to enable you to post reviews,
              and to create a customized shopping experience for you, such as
              recommending products related to your purchases. This may include
              using your personal information to better tailor and improve the
              Services.
            </li>
            <li>
            ...
            <li>
              ...
              information to authenticate your account, to provide a secure payment
              and shopping experience, detect, investigate or take action regarding
              possible fraudulent, illegal, unsafe, or malicious activity, protect
              public safety, and to secure our services. If you choose to use the
              ...
              share your username, password or other access details with anyone else.
            </li>
            <li>
              <strong>Communicating with You.</strong> We use your personal
              information to provide you with customer support, to be responsive to
              you, to provide effective services to you and to maintain our business
          ...
          <ul className={styles.list}>
            <li>
              With Shopify, vendors and other third parties who perform services on
            ...
            <li>
              ...
              advertise to you. For example, we use Shopify to support personalized
              advertising with third-party services based on your online activity
              with different merchants and websites. Our business and marketing
              partners will use your information in accordance with their own privacy
              notices. Depending on where you reside, you may have a right to
              direct us not to share information about you to show you targeted
            ...
            <li>
              ...
              through your use of social media widgets or login integrations.
            </li>
            ...
            <li>
              ...
              enforce any applicable terms of service or policies, and to protect or
              defend the Services, our rights, and the rights of our users or others.
            </li>
          </ul>

          <h2 className={styles.sectionTitle}>Relationship with Shopify</h2>
          <p className={styles.text}>
            ...
            In addition, to help protect, grow, and improve our business, we use
            certain Shopify enhanced features that incorporate data and information
            obtained from your interactions with our Store, along with other
            merchants and with Shopify. To provide these enhanced features, Shopify
            may make use of personal information collected about your interactions
            with our store, along with other merchants, and with Shopify. In these
            ...
            exercise your rights over use of your personal information for these
            purposes. To learn more about how Shopify uses your personal information
            ...
            <a className={styles.link} href="https://privacy.shopify.com/en">
              Shopify Privacy Portal Link
            </a>
            .
          </p>

          <h2 className={styles.sectionTitle}>Third Party Websites and Links</h2>
          <p className={styles.text}>
          ...
          <h2 className={styles.sectionTitle}>Children&apos;s Data</h2>
          <p className={styles.text}>
            ...
            of majority in your jurisdiction. If you are the parent or guardian of
            a child who has provided us with their personal information, you may
            contact us using the contact details set out below to request that it
            be deleted. As of the Effective Date of this Privacy Policy, we do not
            have actual knowledge that we &quot;share&quot; or &quot;sell&quot; (as
          ...
          <ul className={styles.list}>
            ...
            <li>
              ...
              that we transfer it to a third party, in certain circumstances and with
              certain exceptions.
            </li>
            <li>
              <strong>
              ...
              Depending on where you reside, you may have a right to opt out of the
              &quot;sale&quot; or &quot;share&quot; of your personal information or
              to opt out of the processing of your personal information for purposes
              considered to be &quot;targeted advertising&quot;, as defined in
              applicable privacy laws. You can exercise your rights to opt-out of
              those uses{" "}
              <a
                className={styles.link}
                href="https://privacy.shopify.com/en"
              ...
              Control opt-out preference signal enabled, depending on where you are,
              we will automatically treat this as a request to opt-out for the device
              and browser that you use to visit the website. If we are able to
              associate the device sending the signal to a Shopify account, we will
              apply the opt out request to the account as well. To learn more about
          ...
          <p className={styles.text}>
            <strong>If you reside in the UK or European Economic Area,</strong> and
            subject to exceptions and limitations provided by local law, you may
            exercise the following rights in addition to the rights outlined above:
          </p>
          <ul className={styles.list}>
            <li>
              <strong>
            ...
            <li>
              ...
              process your personal information, you have the right to withdraw this
              consent. If you withdraw your consent, this will not affect the
              lawfulness of any processing based on your consent before its
              withdrawal.
            </li>
          </ul>
          <p className={styles.text}>
            You may exercise any of these rights where indicated on the Services or
            by contacting us using the contact details provided below. To learn more
            about how Shopify uses your personal information and any rights you may
            have, including rights related to data processed by Shopify, you can
            visit{" "}
            <a className={styles.link} href="https://privacy.shopify.com/en">
          ...
          <p className={styles.text}>
            ...
            requests on your behalf to exercise your rights. Before accepting such a
            request from an agent, we will require that the agent provide proof you
            have authorized them to act on your behalf, and we may need you to verify
          ...
          <p className={styles.text}>
            ...
            please contact us using the contact details provided below. Depending on
            where you live, you may have the right to appeal our decision by
          ...
          <p className={styles.text}>
            ...
            you, please call or email us at{" "}
            <a
              className={styles.link}
            ...
            or contact us at 4473 Forbes Boulevard, Lanham, MD, 20706, US For the
